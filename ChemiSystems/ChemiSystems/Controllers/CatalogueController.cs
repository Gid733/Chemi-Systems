...
namespace ChemiSystems.Controllers
{
    public class CatalogueController : Controller
    {
        ...
        public ActionResult GetProducts(Guid? id, int? page)
        {
            int pageSize = 3;
            ...
            return PartialView("~/Views/Catalogue/_CatalogueProductsPartial.cshtml", products.ToPagedList(pageNumber, pageSize));
        }
    }
}
/*
